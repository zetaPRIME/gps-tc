...
//Gives Asar-tc the rom filename (for import and other relative functions)
asarfunc void (*asar_setromname)(const char * name);

//Sets library directory string
asarfunc void (*asar_setlibdir)(const char * dir);
